...
if (isset($_POST['teacher_id'])) {
    ...
    $sql = "SELECT * FROM teacher_login_data WHERE teacher_id='" . $_POST['teacher_id'] . "' AND password='" . $_POST['password']. "'
limit 1";
...
<head>
    ...
    <title> Teacher Login for ERP system</title>
    <style>
        body {
            height: 100%;
            width:auto;
...
<body>
    ...
    <div class="container">
        ...
        <div class="background">
            ...
            <div class="login"> Teacher Login
                <div class="login_block">
                    ...
                    limit 1";
                                                    $result = mysqli_query($con, $sql);
                                                    if (mysqli_num_rows($result) != 1) {
                                                        echo ($message = "Invalid Teacher Id or Password !");
            ...
            <div class="signup">
                <a href="create_account_teacher.php" class="signup_underline">Don't have an account, Create account here!</a>
            </div>
