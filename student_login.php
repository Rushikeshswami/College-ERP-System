...
if (isset($_POST['student_id'])) {
    ...
    $sql = "SELECT * FROM student_login_data WHERE student_id='" . $_POST["student_id"] .  "' AND password='" . $_POST["password"] . "'
limit 1";
...
<body>
    ...
    <div class="container">
        ...
        <div class="background">
            ...
            <div class="login"> Student Login
                <div class="login_block">
                    <form action="#" method="post">

                        <label class="id">Student Id:<input type="text" name="student_id" class="text" required></label>
            ...
            <div class="signup">
                <a href="create_account_student.php" class="signup_underline">Don't have an account, Create account here!</a>
            </div>
