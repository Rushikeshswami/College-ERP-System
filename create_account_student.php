...
if (isset($_POST['student_id'])) {
    ...
    if (mysqli_num_rows($result) >0) {
        ...
        if($pass!=$cpass){
            ...
            $insert="INSERT INTO student_login_data(student_id,password,cpassword) values('" . $stud_id . "' ,'". $pass . "','". $cpass ."')";
            mysqli_query($con,$insert);
            echo("Account Created Succesfully!");
            echo header('location:student_login.php');
...
<body>
    ...
    <div class="container">
        ...
        <div class="background">
            ...
            <div class="login"> Create Student's Account
